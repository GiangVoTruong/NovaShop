...
import com.backend.features.user.dto.CreateUserRequestDto;
import com.backend.features.user.dto.GetUserReponseDto;
import com.backend.features.user.dto.UpdateUserProfileRequestDto;
import com.backend.features.user.User;
import com.backend.features.user.mapper.UserMapper;
import com.backend.features.user.repository.UserRepository;
import com.backend.features.auth.security.SecurityUtils;

import lombok.RequiredArgsConstructor;
import com.backend.features.auth.service.EmailVerificationService;
@Service
